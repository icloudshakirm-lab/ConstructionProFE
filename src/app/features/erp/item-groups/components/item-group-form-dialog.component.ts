...
@Component({
  standalone: true,
  selector: 'app-item-group-form-dialog',
  imports: [CommonModule, ReactiveFormsModule, Dialog, Select, Button],
  templateUrl: './item-group-form-dialog.component.html',
  styleUrl: './item-group-form-dialog.component.css',
})
export class ItemGroupFormDialogComponent implements OnInit, OnChanges {
